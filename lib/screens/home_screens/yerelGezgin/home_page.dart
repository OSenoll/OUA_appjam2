...
class YerelGezginPage extends StatefulWidget {
  ...
  @override
  State<YerelGezginPage> createState() => _ChatScreenState();
}

class _ChatScreenState extends State<YerelGezginPage> {
  final TextEditingController _userMessage = TextEditingController();

  static const apiKey = "AIzaSyDovzuzzjj-Ccd_9f33sqOsidWEpFv0TQM";
